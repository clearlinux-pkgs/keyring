...
Version  : 21.3.1
Release  : 83
URL      : https://files.pythonhosted.org/packages/ea/83/53da10efe4e569b0520accc2935c6c993219805765549982924975a0bcf1/keyring-21.3.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ea/83/53da10efe4e569b0520accc2935c6c993219805765549982924975a0bcf1/keyring-21.3.1.tar.gz
...
%prep
%setup -q -n keyring-21.3.1
cd %{_builddir}/keyring-21.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1598282950
...
cp %{_builddir}/keyring-21.3.1/LICENSE %{buildroot}/usr/share/package-licenses/keyring/8e6689d37f82d5617b7f7f7232c94024d41066d1
