...
Source0  : https://files.pythonhosted.org/packages/bd/4f/76c58e52c08ac53ffed2f3d463cd72799adca2aba3e357c7b727baeb8ff6/keyring-22.3.0.tar.gz
...
%prep
%setup -q -n keyring-22.3.0
cd %{_builddir}/keyring-22.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614612298
...
cp %{_builddir}/keyring-22.3.0/LICENSE %{buildroot}/usr/share/package-licenses/keyring/8e6689d37f82d5617b7f7f7232c94024d41066d1
