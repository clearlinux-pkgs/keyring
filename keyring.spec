...
Source0  : https://files.pythonhosted.org/packages/9e/c1/f7851c1f1098f9444363641343ca4e2e461f4473bf97e1dcb405a192ddbb/keyring-22.0.1.tar.gz
...
%prep
%setup -q -n keyring-22.0.1
cd %{_builddir}/keyring-22.0.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611764294
...
cp %{_builddir}/keyring-22.0.1/LICENSE %{buildroot}/usr/share/package-licenses/keyring/8e6689d37f82d5617b7f7f7232c94024d41066d1
